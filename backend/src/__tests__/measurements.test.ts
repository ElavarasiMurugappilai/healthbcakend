...
describe('Measurements Routes', () => {
  ...
  describe('POST /api/measurements', () => {
    ...
    it('should validate blood pressure metadata', async () => {
      const measurementData = {
        ...
        value: '120/80',
        metadata: {
          systolic: 500, // Invalid high value
          diastolic: 80
        }
      };
  ...
  describe('GET /api/measurements/latest', () => {
    beforeEach(async () => {
      const measurements = [
        ...
        },
        {
          ...
          type: 'glucose',
          value: 115,
          timestamp: new Date('2024-01-02T10:00:00Z') // Latest glucose
        },
        {
          userId,
          type: 'weight',
    ...
    it('should get latest measurements by type', async () => {
      ...
      const glucoseMeasurement = response.body.data.find((m: any) => m.type === 'glucose');
      expect(glucoseMeasurement.value).toBe(115); // Should be the latest glucose reading
    });
  });
  ...
  describe('DELETE /api/measurements/:id', () => {
    ...
    it('should not delete measurement of another user', async () => {
      // Create another user's measurement
      ...
      const otherMeasurement = new Measurement({
